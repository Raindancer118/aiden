"""Shared fixtures for the Codescope suite."""
...
def _git_identity() -> None:
    ...
    os.environ.setdefault("GIT_AUTHOR_NAME", "Codescope Tests")
    os.environ.setdefault("GIT_AUTHOR_EMAIL", "tests@codescope.invalid")
    os.environ.setdefault("GIT_COMMITTER_NAME", "Codescope Tests")
    os.environ.setdefault("GIT_COMMITTER_EMAIL", "tests@codescope.invalid")
